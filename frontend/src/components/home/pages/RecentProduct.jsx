    ...
    <div className='bg-cyan-500 dark:bg-cyan-950'>
      {
        ...
        <div className='text-center py-5'>
          <Link to='/recent_products' className='underline text-blue-600'>
            View All
          </Link>
        </div>
      </div>
        ...
        <h2 className='font-semibold text-gray-700 dark:text-gray-300 text-lg md:text-2xl py-4 uppercase'>New Arrivals 🆕</h2>
        <div className=' pb-5'>
