...
const lightings = products.filter(product => product.category === "Lights and Lighting");
// console.log(lightings)
  ...
  return (
    <div className='bg-gray-300 dark:bg-gray-700 mt-5'>
        ...
        <h2 className='font-semibold text-gray-700 dark:text-gray-300 text-lg md:text-2xl py-4 uppercase'>Lights and Lighting 💡</h2>
        <div className=' pb-5'>
          <div className='mt-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
          {lightings.map((product, index) => (
            <div
              key={index}
